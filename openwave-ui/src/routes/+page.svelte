...
<main class="identity-public">
  <nav class="identity-nav">
    ...
    <div class="identity-actions">
      <a href="https://Tellesy.github.io/openwave-spec/" target="_blank" rel="noreferrer">OpenWave Spec</a>
  ...
  <section class="identity-hero">
    <div>
      ...
      <div class="identity-hero-actions">
        ...
        <a href="https://github.com/Tellesy/openwave-identity" target="_blank" rel="noreferrer">View source</a>
      </div>
    </div>
  ...
  <footer>
    ...
    <a href="https://Tellesy.github.io/openwave-spec/guide/npt.html" target="_blank" rel="noreferrer">NPT guide</a>
  </footer>
</main>
